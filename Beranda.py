...
# Deskripsi
st.write("""
Aplikasi ini digunakan untuk mengelompokkan provinsi di Indonesia menggunakan metode HDSBCAN
(Hierarchical Density-Based Spatial Clustering of Applications with Noise) dan Bayesian Optimization
""")
